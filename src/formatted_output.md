"# Title Hadoop Transformation to GCP Phase 2

# Customer Name Bell Canada

# Customer Short Name Bell Canada

# Customer Name Bold **Bell Canada**

# Provision Date 28 May 2024

# MSA Date [MSA Date]

# Opportunity The Client, Bell Canada, is embarking on Phase 2 of its comprehensive Hadoop transformation journey, intended to seamlessly migrate active, mission-critical workloads from a legacy on-premise Hadoop ecosystem to Google Cloud Platform (GCP).
...
# Activities The Provider shall perform the following specific tasks and activities throughout the execution of this engagement:
...
# Deliverables The Provider shall produce and systematically deliver the following specific artifacts during the engagement:
...
# Out of Scope The following operational activities, technical systems, and professional deliverables are strictly and explicitly out of scope for this SOW:
...
# Limitations The Provider's successful execution and delivery of this stated SOW engagement are explicitly subject to the following technical constraints, environmental factors, and operational limitations:
...
# Success Criteria The overall engagement will be deemed successful and structurally complete upon the verified achievement of the following distinct operational criteria:
...
# Technical Assumptions The proposed architectural solution, project methodology, and estimated delivery timelines are directly based upon the following critical foundational assumptions:
...
# Appendix Details **In-Scope Volumetrics** The Provider and Client agree to the following baselined technical volumetrics which formally govern the comprehensive size and scale of this migration effort:
- Hadoop Instance: 1
