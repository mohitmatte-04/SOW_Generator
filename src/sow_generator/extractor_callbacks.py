...
async def before_model_callback(
    ...
    try:
        ...
        is_sow_generated = callback_context.state.get("is_sow_generated")
        if not is_sow_generated:
            ...
            callback_context.state["is_sow_generated"] = True
...
async def after_agent_callback(callback_context: CallbackContext) -> Optional[genai_types.Content]:
    ...
    try:
        ...
        callback_context.state["is_sow_generated"] = False
