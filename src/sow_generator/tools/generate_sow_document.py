...
def _replace_text_with_list(paragraph, key, items, parent_element, font_name=None, font_size=None, use_custom_fonts=True):
    ...
    # Capture initial indentation settings
    initial_left_indent = paragraph.paragraph_format.left_indent
    if initial_left_indent is None:
        initial_left_indent = Inches(0.25) # Default Word bullet list indent
        ...
        if i == 0:
            ...
            if para_numPr is None:
                ...
                if ilvl_elem is not None:
                    ilvl_elem.set('{http://schemas.openxmlformats.org/wordprocessingml/2006/main}val', '0')

            # Apply visual indentation using left_indent to achieve depth
            paragraph.paragraph_format.left_indent = initial_left_indent + Inches(0.25 * indent_level)
            ...
            # Apply visual indentation separately
            new_para.paragraph_format.left_indent = initial_left_indent + Inches(0.25 * indent_level)
